...
import { Wallet, TrendingUp, DollarSign, Shield, ArrowUpRight, ArrowDownRight, Activity } from "lucide-react"
        ...
        <div className="relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              The next-generation decentralized lending platform. Borrow and lend crypto assets with dynamic interest
              rates based on your trust score.
            </p>
            {!isConnected && (
              <Button
      ...
      {isConnected ? (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="gradient-card hover:shadow-lg transition-all duration-300">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-emerald-600">{mockData.trustScore}</div>
                <div className="flex items-center space-x-2 mt-2">
                  <Progress value={mockData.trustScore / 10} className="flex-1" />
            ...
            <Card className="gradient-card hover:shadow-lg transition-all duration-300">
              ...
              <CardContent>
                <div className="text-2xl font-bold">${mockData.totalBorrowed.toLocaleString()}</div>
            ...
            <Card className="gradient-card hover:shadow-lg transition-all duration-300">
              ...
              <CardContent>
                <div className="text-2xl font-bold">${mockData.totalLent.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">Earning 8.5% APY</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="gradient-card">
            <CardHeader>
              ...
              <CardDescription>Your current borrowing capacity based on trust score and collateral</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Eligibility Score</span>
                  <span className="text-2xl font-bold text-emerald-600">{mockData.eligibilityScore}%</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  ...
                  <div className="text-center p-4 rounded-lg bg-muted/50">
                    ...
                    <div className="text-sm text-muted-foreground">Your Interest Rate</div>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-muted/50">
                  ...
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                    ...
                    <div className="text-right">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {activity.type === "lend" ? "Completed" : activity.type === "borrow" ? "Active" : "Paid"}
                      </Badge>
                    </div>
                  </div>
                ))}
        ...
        <Card className="gradient-card text-center p-12">
          <CardContent>
            ...
            <Button onClick={connectWallet} size="lg" className="gradient-primary text-white hover:opacity-90">
              <Wallet className="h-5 w-5 mr-2" />
              Connect Wallet
            </Button>
          </CardContent>
