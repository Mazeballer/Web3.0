...
import { ArrowRight, Shield, TrendingUp, Zap, Users, Lock, Globe, CheckCircle, Star } from "lucide-react"

const features = [
  {
    icon: Shield,
    title: "Trust-Based Lending",
    description: "Dynamic interest rates based on your on-chain reputation and credit score",
  },
  {
    icon: TrendingUp,
    title: "Competitive APY",
    description: "Earn up to 12% APY on your crypto assets with our optimized lending pools",
  },
  {
    icon: Zap,
    title: "Instant Liquidity",
    description: "Access funds immediately with our flash loan technology and instant settlements",
  },
  {
    icon: Lock,
    title: "Secure & Audited",
    description: "Smart contracts audited by leading security firms with $100M+ TVL protection",
  },
  {
    icon: Globe,
    title: "Multi-Chain Support",
    description: "Available on Ethereum, Polygon, and Arbitrum with cross-chain compatibility",
  },
  {
    icon: Users,
    title: "Community Governed",
    description: "Decentralized governance where token holders vote on protocol upgrades",
  },
]
...
const testimonials = [
  {
    name: "Alex Chen",
    role: "DeFi Trader",
    content: "DeFiLend's trust score system gave me better rates than any other platform. The UX is incredible.",
    rating: 5,
  },
  {
    name: "Sarah Johnson",
    role: "Crypto Investor",
    content: "I've been lending on DeFiLend for 6 months. Consistent returns and zero issues with withdrawals.",
    rating: 5,
  },
  {
    name: "Michael Torres",
    role: "DeFi Developer",
    content: "The smart contracts are well-architected and the documentation is top-notch. Highly recommend.",
    rating: 5,
  },
]
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Unlock the power of decentralized finance with trust-based lending, competitive yields, and instant
              liquidity. Built for the next generation of crypto users.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card key={index} className="gradient-card text-center hover:shadow-lg transition-all duration-300">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Experience the next generation of decentralized lending with features designed for both beginners and DeFi
              veterans.
            </p>
          </div>
                  ...
                  >
                    <feature.icon
                      className={`h-6 w-6 transition-colors duration-300 ${
                        hoveredFeature === index ? "text-white" : "text-muted-foreground"
                      }`}
                    />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Connect your MetaMask or any Web3 wallet to get started. No registration required.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Lend your assets to earn yield or borrow against your collateral with competitive rates.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Watch your assets grow with our optimized yield strategies and transparent fee structure.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Your funds are protected by industry-leading security measures and battle-tested smart contracts
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="gradient-card">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Audited by Certik, ConsenSys Diligence, and OpenZeppelin with zero critical vulnerabilities found.
                  </p>
                </CardContent>
              </Card>
              <Card className="gradient-card">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    $100M+ insurance coverage through leading DeFi insurance protocols to protect user funds.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <Card className="gradient-card max-w-4xl mx-auto">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of users who are already earning competitive yields on their crypto assets with DeFiLend.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="gradient-primary text-white hover:opacity-90 text-lg px-8 py-6" asChild>
                  <Link href="/app">
                    Launch App
                    <ArrowRight className="h-5 w-5 ml-2" />
                  </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                The next generation of decentralized lending and borrowing platform.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  <Link href="/app/borrow" className="hover:text-foreground transition-colors">
                    Borrow
                  </Link>
                </li>
                <li>
                  <Link href="/app/lend" className="hover:text-foreground transition-colors">
                    Lend
                  </Link>
                </li>
                <li>
                  <Link href="/app/credit-score" className="hover:text-foreground transition-colors">
                    Credit Score
                  </Link>
                </li>
              </ul>
